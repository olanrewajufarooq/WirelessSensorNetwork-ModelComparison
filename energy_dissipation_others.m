function [SN, round_params, int_conn_start, int_conn_start_check] = energy_dissipation_others(SN, round, ms_ids, pn_ids, energy, k, round_params, int_conn_start, int_conn_start_check)
